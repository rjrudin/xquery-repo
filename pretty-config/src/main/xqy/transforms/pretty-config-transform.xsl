    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body class="container">
        ...
        <div class="tab-content">
          <xsl:apply-templates select="rapi:resources[element()]" />
          <xsl:apply-templates select="rapi:query-options[element()]" />
          <xsl:apply-templates select="rapi:transforms[element()]" />
        </div>
